import 'package:cancer_care_app/app/modules/home/controllers/home_controller.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text("CancerCare",style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold),),
        ...
        children: [
          const Text.rich(
            TextSpan(
              ...
              children: [
                TextSpan(text: "Looking For you desired\n"),
                TextSpan(
                ...
                TextSpan(text: "\n\n"),
                TextSpan(
                  text: "\nGet a discount of 20% on your \nfirst appointment",
                ),
              ],
            ),
          ),
          Expanded(child: Image.asset("assets/images/doctor_ad.png")),
        ],
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 20),
          child: SectionTitle(title: "Available Doctor", press: () {}),
        ),
        SingleChildScrollView(
          scrollDirection: Axis.horizontal,
          child: Row(
